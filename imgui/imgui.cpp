...
// - Call and read ImGui::ShowMainWindow() in imgui_demo.cpp. All applications in examples/ are doing that.
...
/*
 ...
 - Call and read ImGui::ShowMainWindow() for demo code demonstrating most features.
 ...
 - 2019/12/08 (1.75) - removed redirecting functions/enums that were marked obsolete in 1.53 (December 2017):
                       - ShowTestWindow()                    -> use ShowMainWindow()
 ...
 - 2017/12/24 (1.53) - renamed the emblematic ShowTestWindow() function to ShowMainWindow(). Kept redirection function (will obsolete).
 ...
 A: This library is poorly documented at the moment and expects of the user to be acquainted with C/C++.
    ...
    - See demo code in imgui_demo.cpp and particularly the ImGui::ShowMainWindow() function.
